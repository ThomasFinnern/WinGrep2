            ...
            try
            {
                ...
                */
                ...
                else
                {
                    ...
                    // Einen freien Temp�rardateinamen abfragen 
                    // VORSICHT: Der zur�ckgegebene Dateiname 
                    //' wird (als leere Datei) angelegt! 
                    //strTempFile = IO.Path.GetTempFileName 

                    //' Einen StreamWriter f�r das Schreiben in die 
                    //' Tempor�rdatei neu anlegen: 
                    //Dim StreamW As IO.StreamWriter _ 
                    //            = New IO.StreamWriter(strTempFile) 
                    //StreamW.WriteLine("Text, der in der Tempor�rdatei gespeichert wird.") 
                    //StreamW.Close() 
                    ...
                    //' Aus der Tempor�rdatei ausgelesenen Text ausgeben: 
                    //Console.WriteLine("Die Tempor�rdatei{0}{1}{0}wurde genutzt, " & _ 
                    //                  "um den folgenden Text zwischenzuspeichern:{0}{2}", _ 
                    //                  vbNewLine, strTempFile, strRead) 

                    //' Tempor�rdatei l�schen  
                    //Kill(strTempFile)
