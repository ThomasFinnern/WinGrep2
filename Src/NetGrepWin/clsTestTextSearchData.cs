...
namespace NetGrep
{
    public class clsTestTextSearchData : clsConfigSpezialBase<clsTestTextSearchData>
    {
        //---------------------------------------------------------------------------------------------
        // Config variables 
        //---------------------------------------------------------------------------------------------
        ...
        public clsTestTextSearchData()
        {
            CfgFileName = "TestTextSearchData.txt";
        ...
        public override string ToString()
        {
            ...
            OutTxt = OutTxt + "TestTextSearchData:" + "\r\n";
