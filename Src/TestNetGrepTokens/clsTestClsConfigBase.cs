...
{
    [Serializable]
    public class clsTestClsConfigBase : clsConfigBase <clsTestClsConfigBase>
    {
        //---------------------------------------------------------------------------------------------
        // Config variables 
        //---------------------------------------------------------------------------------------------
        ...
        {
            bool ErrFound = false;
            string ErrInfoTxt = "Error in clsTestClsConfigBase: ";

            try
            {
                clsTestClsConfigBase Test1 = new clsTestClsConfigBase();
                string FileName = @".\clsTestClsConfigBase.01.txt";
                ...
                clsTestClsConfigBase Test2 = clsTestClsConfigBase.LoadClassFromFile(FileName);
