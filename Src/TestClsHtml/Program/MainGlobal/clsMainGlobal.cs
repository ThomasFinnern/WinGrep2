...
namespace MainGlobal
{
    ...
    class Global
    {
        ...
        private static clsConfigTestClsHtmlGrep mConfig = clsConfigTestClsHtmlGrep.LoadClassOrCreateUserFile();
        public static clsConfigTestClsHtmlGrep Config
        {
            get { return mConfig; }
            set { mConfig = value; }
        }
        ...
        public static void InitGlobalObjects()
        {
            ...
            //DoCmdGrepProperties = new clsSearchProperties ();
        }
